...
const contractABI = require("../artifacts/contracts/Polkadotparachain.sol/Polkadotparachain.json").abi;

program
    .name("polkadotparachain-cli")
    .description("CLI tool for Polkadotparachain smart contract")
    .version("1.0.0");
